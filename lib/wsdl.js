...
WSDL.prototype.defaultTimezone = null;
...
WSDL.prototype._initializeOptions = function (options) {
  ...
  this.options.defaultTimezone = options.defaultTimezone || this.defaultTimezone;
...
WSDL.prototype.xmlToObject = function(xml, callback) {
  ...
  p.ontext = function(text) {
    ...
    if (name === 'int' || name === 'integer') {
      ...
      if (self.options.defaultTimezone) {
        value = moment.tz(text, self.options.defaultTimezone);
      } else {
        value = moment(text);
      }
    } else {
